...
const imageSources = {
    ...
    fighter: 'assets/img/fighter.png',
    heavy: 'assets/img/heavy.png',
    elite: 'assets/img/elite.png',
    bomber: 'assets/img/bomber.png',
    phantom: 'assets/img/phantom.png',
    sniper: 'assets/img/sniper.png',
    paladin: 'assets/img/paladin.png',
    healer: 'assets/img/healer.png',
    boss: 'assets/img/boss.png',
    droneAttack: 'assets/img/droneAttack.png',
    droneHealer: 'assets/img/droneHealer.png',
    droneCollector: 'assets/img/droneCollector.png',
    projectilePlayer: 'assets/img/projectilePlayer.png',
    projectileEnemy: 'assets/img/projectileEnemy.png',
    powerupHeal: 'assets/img/powerupHeal.png',
    powerupShield: 'assets/img/powerupShield.png',
    powerupFury: 'assets/img/powerupFury.png',
    asteroid: 'assets/img/asteroid.png',
    asteroidHeavy: 'assets/img/asteroidHeavy.png',
    loot: 'assets/img/loot.png',
    explosion: 'assets/img/explosion.png'
};

function generateFallbackSprite(key) {
    switch (key) {
        case 'player': return generatePlayerSprite();
        case 'scout': return generateScoutSprite();
        case 'fighter': return generateFighterSprite();
        case 'heavy': return generateHeavySprite();
        case 'elite': return generateEliteSprite();
        case 'bomber': return generateBomberSprite();
        case 'phantom': return generatePhantomSprite();
        case 'sniper': return generateSniperSprite();
        case 'paladin': return generatePaladinSprite();
        case 'healer': return generateHealerSprite();
        case 'boss': return generateBossSprite();
        case 'droneAttack': return generateDroneAttackSprite();
        case 'droneHealer': return generateDroneHealerSprite();
        case 'droneCollector': return generateDroneCollectorSprite();
        case 'projectilePlayer': return generateProjectilePlayerSprite();
        case 'projectileEnemy': return generateProjectileEnemySprite();
        case 'powerupHeal': return generatePowerupSprite('heal');
        case 'powerupShield': return generatePowerupSprite('shield');
        case 'powerupFury': return generatePowerupSprite('fury');
        case 'asteroid': return generateAsteroidSprite(false);
        case 'asteroidHeavy': return generateAsteroidSprite(true);
        case 'loot': return generateLootSprite();
        case 'explosion': return generateExplosionFrames();
        default: return createCanvas(16, 16);
    }
}
...
function loadAssets(callback) {
    ...
    for (const [key, src] of Object.entries(imageSources)) {
        ...
        img.onload = () => {
            if (key === 'explosion') {
                // Slice the 512x64 spritesheet into 8 frames of 64x64
                const frames = [];
                for (let f = 0; f < 8; f++) {
                    const c = createCanvas(64, 64);
                    const x = c.getContext('2d');
                    x.drawImage(img, f * 64, 0, 64, 64, 0, 0, 64, 64);
                    frames.push(c);
                }
                SPRITES.explosion = frames;
            } else {
                SPRITES[key] = img;
            }
            checkComplete();
